...
data = all_data[swan_cols + diag_cols]
print(data.columns)
print(data) 
...
data = all_data[srs_cols + diag_cols]
data["SRS_score"] = data[srs_cols].sum(axis=1) # https://sci-hub.mksa.top/10.1177/0734282913517525 
